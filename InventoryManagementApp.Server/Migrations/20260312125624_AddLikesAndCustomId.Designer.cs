...
namespace InventoryManagementApp.Server.Migrations
{
    ...
    [Migration("20260312125624_AddLikesAndCustomId")]
    partial class AddLikesAndCustomId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagementApp.Server.Entities.DiscussionPost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("InventoryManagementApp.Server.Entities.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventoryManagementApp.Server.Entities.ItemLike", b =>
                {
            ...
            modelBuilder.Entity("InventoryManagementApp.Server.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InventoryManagementApp.Server.Entities.Item", b =>
                {
                    b.HasOne("InventoryManagementApp.Server.Entities.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("InventoryManagementApp.Server.Entities.ItemLike", b =>
                {
                    b.HasOne("InventoryManagementApp.Server.Entities.Item", "Item")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("InventoryTag", b =>
                {
                    b.HasOne("InventoryManagementApp.Server.Entities.Inventory", null)
                        .WithMany()
                        .HasForeignKey("InventoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryManagementApp.Server.Entities.Tag", null)
                        .WithMany()
